...
for seat in seats_to_buy:
    ...
    """, (ticket_id, ticket_price_type, seat_number, row_number, hall_area_name, show_date, show_time, hall_id, play_id, ticket_purchase_id))
    ticket_id += 1

    print(f"Kjøpte en {ticket_price_type} billett på setenummer {seat_number} og radnummer {row_number} i salområdet {hall_area_name}")
